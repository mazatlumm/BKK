...
const App = () => {
    ...
    const handleNotification = () => {
        ...
        //     channelId:"abogoboga",
        //     title:"Alarm",
        //     message:"Anda Berhasil Login 10 detik yang lalu",
    ...
    if(StatusKoneksi){
        return (
            <View style={{ flex: 1 }}>
                ...
                <WebView 
                    ...
                    source={{uri: 'https://alicestech.com/bkk_skansaji'}} 
                    ...
                    onMessage={(event) => {
                        ...
                        storeDataIdSuser(event.nativeEvent.data);
                        setIDUser(event.nativeEvent.data);
        ...
        return (
            <View style={{height:'100%', justifyContent:'center', alignItems:'center'}}>
                <Image style={{width:'27%', height:'27%', resizeMode:'contain', marginVertical:0, paddingVertical:0 }} source={require('./assets/logoApp.png')} />
